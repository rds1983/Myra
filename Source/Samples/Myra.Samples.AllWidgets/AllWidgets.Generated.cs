/* Generated by Myra UI Editor at 28.11.2018 21:19:22 */
...
namespace Myra.Samples.AllWidgets
{
	partial class AllWidgets
	{
		private void BuildUI()
		{
			...
			_buttonSaveFile.ContentHorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			_buttonSaveFile.ContentVerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			_buttonSaveFile.Id = "_buttonSaveFile";
			_buttonSaveFile.PaddingLeft = 8;
			_buttonSaveFile.PaddingRight = 8;
			_buttonSaveFile.GridPositionX = 1;

			_textSaveFile = new TextField();
			_textSaveFile.Text = "";
			_textSaveFile.Readonly = true;
			_textSaveFile.Id = "_textSaveFile";
			_textSaveFile.GridPositionX = 2;

			var textBlock2 = new TextBlock();
			textBlock2.Text = "Button 2:";
			textBlock2.Id = "";
			textBlock2.GridPositionY = 1;

			_buttonOpenFile = new Button();
			_buttonOpenFile.Text = "Open File";
			_buttonOpenFile.ContentHorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			_buttonOpenFile.ContentVerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			_buttonOpenFile.Id = "_buttonOpenFile";
			_buttonOpenFile.PaddingLeft = 8;
			_buttonOpenFile.PaddingRight = 8;
			_buttonOpenFile.GridPositionX = 1;
			_buttonOpenFile.GridPositionY = 1;

			_textOpenFile = new TextField();
			_textOpenFile.Text = "";
			_textOpenFile.Readonly = true;
			_textOpenFile.Id = "_textOpenFile";
			_textOpenFile.GridPositionX = 2;
			_textOpenFile.GridPositionY = 1;
			...
			_buttonChooseFolder.ContentHorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			_buttonChooseFolder.ContentVerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			_buttonChooseFolder.Id = "_buttonChooseFolder";
			_buttonChooseFolder.PaddingLeft = 8;
			_buttonChooseFolder.PaddingRight = 8;
			_buttonChooseFolder.GridPositionX = 1;
			_buttonChooseFolder.GridPositionY = 2;

			_textChooseFolder = new TextField();
			_textChooseFolder.Text = "";
			_textChooseFolder.Readonly = true;
			_textChooseFolder.Id = "_textChooseFolder";
			_textChooseFolder.GridPositionX = 2;
			_textChooseFolder.GridPositionY = 2;

			_textButtonLabel = new TextBlock();
			_textButtonLabel.Text = "Text Button:";
			_textButtonLabel.Id = "_textButtonLabel";
			_textButtonLabel.GridPositionY = 3;
			...
			_buttonChooseColor.GridPositionX = 1;
			_buttonChooseColor.GridPositionY = 3;
			...
			checkBox1.GridPositionY = 5;
			checkBox1.GridSpanX = 3;
			...
			horizontalSlider1.GridPositionY = 6;
			horizontalSlider1.GridSpanX = 2;
			...
			comboBox1.GridPositionY = 7;
			comboBox1.GridSpanX = 2;
			...
			textField1.GridPositionY = 8;
			textField1.GridSpanX = 2;
			...
			spinButton1.GridPositionY = 9;
			spinButton1.GridSpanX = 2;
			...
			listBox1.GridPositionY = 10;
			listBox1.GridSpanX = 2;
			...
			verticalMenu1.GridPositionY = 11;
			verticalMenu1.GridSpanX = 2;
