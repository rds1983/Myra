/* Generated by Myra UI Editor at 18.10.2018 2:06:16 */
...
namespace Myra.Graphics.UI.ColorPicker
{
	partial class ColorPickerDialog
	{
		private void BuildUI()
		{
			...
			grid4.GridPositionY = 1;
			grid4.Widgets.Add(_imageColor);
			grid4.Widgets.Add(horizontalSeparator1);
			grid4.Widgets.Add(grid3);
			grid4.Widgets.Add(horizontalSeparator2);
