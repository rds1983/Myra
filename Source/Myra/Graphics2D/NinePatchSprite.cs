...
{
	public class NinePatchSprite : ImageDrawable
	{
		private readonly NinePatchInfo _info;
		...
		public NinePatchSprite(TextureRegion region, NinePatchInfo info) : base(region)
		{
			_info = info;
