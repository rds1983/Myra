...
copy "Myra.Samples\bin\%CONFIGURATION%\Myra.Samples.FNA.dll" ZipPackage /Y
copy "Myra.Samples\bin\%CONFIGURATION%\Myra.Samples.FNA.pdb" ZipPackage /Y
...
copy "Myra.Samples.FNALauncher\bin\%CONFIGURATION%\Myra.Samples.FNALauncher.exe" ZipPackage /Y
copy "Myra.Samples.FNALauncher\bin\%CONFIGURATION%\Myra.Samples.FNALauncher.exe.config" ZipPackage /Y
copy "Myra.Samples.FNALauncher\bin\%CONFIGURATION%\Myra.Samples.FNALauncher.pdb" ZipPackage /Y
...
copy "Myra-Dependencies\FNA\libSDL2-2.0.so.0" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\libopenal.so.1" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\libmojoshader.so" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\SDL2.dll" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\soft_oal.dll" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\MojoShader.dll" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\libSDL2-2.0.0.dylib" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\libopenal.1.dylib" "ZipPackage\FNA" /Y
copy "Myra-Dependencies\FNA\libmojoshader.dylib" "ZipPackage\FNA" /Y
