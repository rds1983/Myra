	...
	public class UndoState
	{
		...
		public void DiscardUndo()
		{
			if ((undo_point) > (0))
			{
				...
				{
					int n = (int)(undo_rec[0].insert_length);
					undo_char_point -= n;

					Array.Copy(undo_char, n, undo_char, 0, undo_char_point);
					for (var i = (int)(0); (i) < (undo_point); ++i)
					{
		...
		public void DiscardRedo()
		{
			...
			if (redo_point <= k)
			{
				...
				{
					int n = (int)(undo_rec[k].insert_length);
					int i;
					redo_char_point += n;
