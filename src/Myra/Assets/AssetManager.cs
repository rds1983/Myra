...
namespace Myra.Assets
{
	public class AssetManager: IAssetManager
	{
		...
		private static void RegisterDefaultLoaders()
		{
			...
			SetAssetLoader(new StaticSpriteFontLoader());
			SetAssetLoader(new FontSystemLoader());
			SetAssetLoader(new DynamicSpriteFontLoader());
			SetAssetLoader(new SpriteFontBaseLoader());
		}
