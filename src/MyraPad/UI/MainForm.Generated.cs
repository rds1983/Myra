/* Generated by MyraPad at 8/12/2026 10:00:45 PM */
using Myra;
...
namespace MyraPad.UI
{
	partial class MainForm: VerticalStackPanel
	{
		private void BuildUI()
		{
			...
			_menuFileExportToCSLight = new MenuItem();
			_menuFileExportToCSLight.Text = "&Export To C# Light...";
			_menuFileExportToCSLight.ShortcutText = "Ctrl+W";
			_menuFileExportToCSLight.Id = "_menuFileExportToCSLight";
			...
			_menuFileSaveStylesheet = new MenuItem();
			_menuFileSaveStylesheet.Text = "Save St&ylesheet";
			_menuFileSaveStylesheet.Id = "_menuFileSaveStylesheet";
			...
			_menuFile.Items.Add(_menuFileExportToCSLight);
			...
			_menuFile.Items.Add(_menuFileSaveStylesheet);
			...
			tabItem1.Text = "Project";
			tabItem1.Content = _panelExplorer;

			_panelStyles = new ScrollViewer();
			_panelStyles.Id = "_panelStyles";

			_panelStyleExplorer = new ScrollViewer();
			_panelStyleExplorer.Id = "_panelStyleExplorer";

			var verticalSplitPane1 = new VerticalSplitPane();
			verticalSplitPane1.Widgets.Add(_panelStyles);
			verticalSplitPane1.Widgets.Add(_panelStyleExplorer);

			_tabStylesheet = new TabItem();
			_tabStylesheet.Text = "Stylesheet";
			_tabStylesheet.Id = "_tabStylesheet";
			_tabStylesheet.Content = verticalSplitPane1;

			_tabControlLeft = new TabControl();
			_tabControlLeft.HorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			_tabControlLeft.VerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			_tabControlLeft.Id = "_tabControlLeft";
			_tabControlLeft.Items.Add(tabItem1);
			...
			_propertyGridPane.ShowHorizontalScrollBar = false;
			...
			verticalStackPanel2.Background = new SolidBrush("Black");
			...
			_topSplitPane.Widgets.Add(_tabControlLeft);
		...
		public MenuItem _menuFileExportToCSLight;
		public MenuItem _menuFileLoadStylesheet;
		public MenuItem _menuFileResetStylesheet;
		public MenuItem _menuFileSaveStylesheet;
		...
		public ScrollViewer _panelStyles;
		public ScrollViewer _panelStyleExplorer;
		public TabItem _tabStylesheet;
		public TabControl _tabControlLeft;
