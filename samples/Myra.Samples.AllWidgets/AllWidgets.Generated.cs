/* Generated by MyraPad at 12/1/2023 10:36:59 PM */
using Myra;
...
namespace Myra.Samples.AllWidgets
{
	partial class AllWidgets: Panel
	{
		private void BuildUI()
		{
			...
			comboView1.Widgets.Add(label11);

			var label12 = new Label();
			label12.Text = "Text Field:";
			...
			label13.Text = "Spin Button:";
			Grid.SetRow(label13, 9);
			...
			label14.Text = "List View:";
			Grid.SetRow(label14, 10);

			var label15 = new Label();
			label15.Text = "Red";
			label15.TextColor = Color.Red;

			var label16 = new Label();
			label16.Text = "Green";
			label16.TextColor = Color.Lime;

			var label17 = new Label();
			label17.Text = "Blue";
			label17.TextColor = Color.Blue;
			...
			listView1.Widgets.Add(label16);
			listView1.Widgets.Add(label17);

			var label18 = new Label();
			label18.Text = "Vertical Menu:";
			Grid.SetRow(label18, 11);
			...
			_gridRight.Widgets.Add(label19);
