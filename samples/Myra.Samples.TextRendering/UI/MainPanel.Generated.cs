/* Generated by MyraPad at 2/22/2026 10:32:19 AM */
using Myra;
...
namespace Myra.Samples.TextRendering.UI
{
	partial class MainPanel: Panel
	{
		private void BuildUI()
		{
			...
			_spinButtonFontSize = new SpinButton<float>();
			_spinButtonFontSize.Value = 32f;
			_spinButtonFontSize.Increment = 1f;
			_spinButtonFontSize.Mul_Increment = 1f;
			_spinButtonFontSize.DecimalPlaces = 0;
			...
			_sliderScale.Maximum = 10f;
			_sliderScale.Value = 1f;
			...
			_spinButtonResolutionFactor = new SpinButton<float>();
			_spinButtonResolutionFactor.Minimum = 1f;
			_spinButtonResolutionFactor.Value = 1f;
			_spinButtonResolutionFactor.Increment = 1f;
			_spinButtonResolutionFactor.Mul_Increment = 1f;
			_spinButtonResolutionFactor.DecimalPlaces = 0;
			...
			_spinButtonKernelWidth = new SpinButton<float>();
			_spinButtonKernelWidth.Minimum = 0f;
			_spinButtonKernelWidth.Value = 0f;
			_spinButtonKernelWidth.Increment = 1f;
			_spinButtonKernelWidth.Mul_Increment = 1f;
			_spinButtonKernelWidth.DecimalPlaces = 0;
			...
			_spinButtonKernelHeight = new SpinButton<float>();
			_spinButtonKernelHeight.Minimum = 0f;
			_spinButtonKernelHeight.Value = 0f;
			_spinButtonKernelHeight.Increment = 1f;
			_spinButtonKernelHeight.Mul_Increment = 1f;
			_spinButtonKernelHeight.DecimalPlaces = 0;
		...
		public SpinButton<float> _spinButtonFontSize;
		...
		public SpinButton<float> _spinButtonResolutionFactor;
		public SpinButton<float> _spinButtonKernelWidth;
		public SpinButton<float> _spinButtonKernelHeight;
