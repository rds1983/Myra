/* Generated by MyraPad at 2/22/2026 2:29:34 AM */
using Myra;
...
namespace Myra.Samples.TextRendering.UI
{
	partial class MainPanel: Panel
	{
		private void BuildUI()
		{
			...
			_spinButtonFontSize.Increment = 1;
			_spinButtonFontSize.Mul_Increment = 1;
			...
			_spinButtonResolutionFactor.Increment = 1;
			_spinButtonResolutionFactor.Mul_Increment = 1;
			...
			_spinButtonKernelWidth.Increment = 1;
			_spinButtonKernelWidth.Mul_Increment = 1;
			...
			_spinButtonKernelHeight.Increment = 1;
			_spinButtonKernelHeight.Mul_Increment = 1;
		...
		public SpinButton`1 _spinButtonFontSize;
		...
		public SpinButton`1 _spinButtonResolutionFactor;
		public SpinButton`1 _spinButtonKernelWidth;
		public SpinButton`1 _spinButtonKernelHeight;
