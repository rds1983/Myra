...
mgcb /outputDir:bin/Windows /intermediateDir:obj/Windows /platform:Windows /reference:D:\Projects\Hebron\Myra\Myra.Content.Pipeline\bin\Debug\Myra.Content.Pipeline.dll /importer:EffectImporter /processor:MultiCompileEffectProcessor /build:Shaders\TerrainEffect.fx
...
mgcb /outputDir:bin/Linux /intermediateDir:obj/Linux /platform:Linux /reference:D:\Projects\Hebron\Myra\Myra.Content.Pipeline\bin\Debug\Myra.Content.Pipeline.dll /importer:EffectImporter /processor:MultiCompileEffectProcessor /build:Shaders\TerrainEffect.fx
